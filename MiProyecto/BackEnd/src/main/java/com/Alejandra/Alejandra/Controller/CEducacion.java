...
import com.Alejandra.Alejandra.Dto.dtoEducacion;
import com.Alejandra.Alejandra.Entity.Educacion;
import com.Alejandra.Alejandra.Security.Controller.Mensaje;
import com.Alejandra.Alejandra.Service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        //usar el metodo save del service 
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        //despues de las validaciones, se actualiza el objeto
        Educacion educacion = sEducacion.getOne(id).get();
